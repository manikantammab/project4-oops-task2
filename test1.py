...
class stringClass:
    ...
    def extractStrInRange(self):
        try:
            logging.info('extracting data from index 1 to 300 with jump 3')
    ...
    def strCapitilize(self):
        try:
            logging.info('converting the whole string into capitalizing')
...
class listClass:
    ...
    def extractAllListEntity(self):
        try:
            logging.info('extracting all list entity from collection')
            for i in self.ls1:
                if type(i)==list:
                    logging.info(i)
        except Exception as e:
    ...
    def filterOddFromList(self):
        try:
            logging.info('try to fillter out odd values from all numeric data')
            for i in self.ls1:
                if type(i)==list:
                    for k in i:
                        if type(k)==int:
    ...
    def access456FromList(self):
        try:
            logging.info('accessiing 456 from list without for loop')
            return self.ls2[5][1]
        except Exception as e:
            logging.error(e)
    def extractOnlyList(self):
        try:
            ...
            logging.info('extarct List 2 from the collection without for loop')
...
class tupleClass:
    ...
    def extractTuples(self):
        try:
            logging.info('extracting all tuple entity from collection')
            for i in self.ls:
                if type(i)==tuple:
                    logging.info(i)
        except Exception as e:
...
class dictClass:
    ...
    def extractValueFromDict(self):
        try:
            ...
            logging.info('extracting forst value without for loop')
...
logging.info(listObj.reverseList())
